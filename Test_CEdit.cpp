...
BEGIN_MESSAGE_MAP(CTest_CEditApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CTest_CEditApp construction

CTest_CEditApp::CTest_CEditApp()
{
...
// The one and only CTest_CEditApp object

CTest_CEditApp theApp;


// CTest_CEditApp initialization
